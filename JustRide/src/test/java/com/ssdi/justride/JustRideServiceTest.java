...
public class JustRideServiceTest {
	...
	public void emailValidation() {
		...
		boolean emailValidation = justRideService.validateEmail("rbalanka2@uncc.edu");
...
//		User testUser = new User("testUser", "testLastname", "test@testttttt", "testPass", "123456", "1234-123",
//				"1234");
...
//	}
	...
	public void userValidation() {
		User testUser = new User("testUser", "testLastname", "test@test", "ere","testPass", "123456", "1234-123", "1234");
		...
		// invalidEmail
		boolean invalidEmail = justRideService.validateEmail("invalidEMail@test");
